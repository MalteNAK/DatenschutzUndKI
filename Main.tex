...
\hline
\textbf{Eingabeaufforderung} & \textbf{Zweck der Nutzung} & \textbf{Bewertung der Ausgabe} & \textbf{Genutztes Modell} \\
...
\emph{Korrigiere und bewerte folgende Textpassage: [...]} &
\emph{Einschätzung der inhaltlichen und sprachlichen Qualität} &
\emph{hilfreich bei der Fehlererkennung und inhaltlichen Verbesserung} &
\emph{Gemini 3 Pro} \\
\hline

\emph{Formuliere folgenden Text wissenschaftlich präziser: [...]} &
\emph{Sprachliche Überarbeitung} &
\emph{mittelmäßige Überarbeitung, häufig zu ungenau} &
\emph{ChatGPT 5.1} \\
\hline

\emph{Erkläre mir folgendes Thema: [...]}
\emph{Einstieg in die einzelnen Themengebiete}
\emph{guter Überblich und Startpunkt}
\emph{ChatGPT 5.1/Gemini 3 Pro}
