...
\fancyhead[R]{\includegraphics[width=2.5cm]{Resources/Nordakademie_Logo.png}} % Zeigt das Logo rechts an
...
\emph{[z.\,B. Strukturierung eines Kapitels]} &
\emph{[z.\,B. inhaltlich geeignet, sprachlich überarbeitet]} &
\emph{[z.\,B. ChatGPT, GPT-4]} \\
\hline

\emph{[Prompt hier einfügen]} &
\emph{[z.\,B. Formulierung eines Übergangs]} &
\emph{[z.\,B. teilweise übernommen, fachlich ergänzt]} &
\emph{[z.\,B. ChatGPT, GPT-4]} \\
\hline
