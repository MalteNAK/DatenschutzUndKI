...
Foucault definiert den Autor, indem er ihn nicht als natürliche Person, sondern als Funktion des Diskurses beschreibt, die insbesondere dort relevant wird, wo Verantwortung, Eigentum und Kontrolle geregelt werden müssen (vgl. \cite{Foucault_WasIstEinAutor_1969}). 
...
explorative und transformatorische Kreativität (vgl. \cite{Boden_MindsAndMachines_2009}). Kombinatorische
...
als Verantwortung innerhalb eines Informationsökosystems verstehen (vgl. \cite{Floridi_EthicsOfInformation_2013}).
...
Diese Differenz zeigt sich besonders deutlich in Kontexten, in denen Autorschaft mit Zurechenbarkeit verknüpft ist: Während menschliche Autoren Gründe angeben, Absichten vertreten und Verantwortung übernehmen können, kann ein Modell dies nur sprachlich simulieren, indem es Muster von Begründungen reproduziert. Auch wenn LLM-Ausgaben für Rezipienten originell wirken können, folgt daraus weder ein innerer Sinnhorizont noch ein normativ zurechenbares Handeln.\par
