...
Die Generierung eines KI-basierten Werkes lässt sich vereinfacht als Dreischritt beschreiben: \textit{Prompt} → \textit{Modell} → \textit{Output}. Anders als bei klassischer Werkschöpfung sind dabei mehrere technische Komponenten beteiligt, die das Ergebnis mitprägen. Diese verteilte Werkgenese führt zu einer Form der Verantwortungsdiffusion, wie sie für algorithmische Systeme typisch ist: Entscheidungen und Effekte lassen sich nicht mehr eindeutig einzelnen Akteuren zuschreiben (vgl. \cite{Mittelstadt_EthicsOfAlgorithms_2016}).
