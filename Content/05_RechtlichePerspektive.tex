...
Im interdisziplinären Vergleich wird deutlich, dass das Recht nicht primär beschreibt, wie kreative Leistungen entstehen, sondern Ordnung schafft, indem es Verantwortung, Schutz und Verwertungsrechte eindeutig zuweist. Dabei entstehen Spannungen zu technischen und ethischen Perspektiven, die Autorschaft relationaler und gradueller denken.

Autorschaft fungiert rechtlich somit weniger als Abbild kreativer Realität denn als stabilisierende Kategorie. Die verbleibenden Differenzen zu technischen Beschreibungen und ethischen Bewertungen markieren keine Fehlstellen einzelner Disziplinen, sondern verweisen auf die Notwendigkeit einer interdisziplinären Gesamtsicht, wie sie im abschließenden Synthesekapitel vorgenommen wird.
