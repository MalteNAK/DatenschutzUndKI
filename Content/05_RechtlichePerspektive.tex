...
Der AI Act ergänzt die Urheberrechtsfrage um einen risikobasierten Regulierungsrahmen für KI-Systeme. Für generative KI und General-Purpose AI Models (GPAI) sind insbesondere Pflichten relevant, die sich in technische Umsetzungsaufgaben übersetzen lassen~\cite{eu_ai_act_2024}.
...
Aus rechtlicher Perspektive wird deutlich, dass Gesetze nicht primär beschreiben, wie kreative Leistungen entstehen, sondern Ordnung schaffen, indem sie Verantwortung, Schutz und Rechte eindeutig zuweisen. Dabei entstehen Spannungen zwischen technischen und ethischen Perspektiven, die Autorschaft relationaler und gradueller denken. Auch sind diese Gesetzte technologieoffen gestaltet, sodass sie zwar Rahmenbedingungen setzen, aber dem technischen Wandel nicht im Wege stehen.
